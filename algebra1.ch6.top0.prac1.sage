		'''
This is testing the truth of statements of inequality, with strict inequalities
'''

attach yaml_format.sage
import random

myFile = open('algebra1.ch6.top0.prac1.txt','w')
create_html_html_multiple_question_set(myFile)
myFile.close()
myFile = open('algebra1.ch6.top0.prac1.txt','a')

def test_inequality(x, y, sign): 
	truth_of_statement = (x>y and sign == ">") or (x<y and sign == "<")
