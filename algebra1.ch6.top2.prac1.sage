...
myFile = open('algebra1.ch6.top2.prac1.txt','w')
create_html_html_multiple_question_set(myFile)
myFile.close()
myFile = open('algebra1.ch6.top2.prac1.txt','a')
...
def wrapper():
	...
	for a in a_range:
		for b in b_range:
			for sign in [gt, lt, ge, le]: #literally wraps through the functions, greater than, less than, etc, not just strings representing them
