...
This will generate the problem 0-0 with 0 as a distractor, and make_answer_list fails to drop it. 
"""

attach yaml_format.sage

myFile = open('rmorey.algebra1.ch0.sec1.top4.v1.txt','w')
create_html_html_multiple_question_set(myFile)
myFile.close()
myFile = open('rmorey.algebra1.ch0.sec1.top4.v1.txt','a')
