'''
5.1.2
given graph of  a line, write an equation in slope-intercept form
author: rmorey
'''
...
QUESTIONSET_FILENAME = "algebra1.ch5.top1.prac2.yml"
INSTRUCTION_STRING = "Write an equation for the graph of the line shown."
...
def format_solution(answer_list,equation):
	question_string = equation.graph_line_question()
